...
describe('an AddComment entities', () => {
  it('should throw error when payload did not contain needed property', () => {
    ...
    expect(() => new AddComment(threadId, payload, userId)).toThrow('ADD_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY');
  });
  ...
  it('should throw error when payload did not meet data type specification', () => {
    ...
    expect(() => new AddComment(threadId, payload, userId)).toThrow('ADD_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION');
  });
